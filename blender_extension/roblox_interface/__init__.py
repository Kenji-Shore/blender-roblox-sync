...
def register(utils):
    ...
    class SyncList(bpy.types.UIList):
    ...
    class VIEW3D_PT_roblox_sync(bpy.types.Panel):
        ...
        def draw(self, context):
            ...
            col.template_list("SyncList", "", context.scene, "currently_syncing", context.scene, "currently_syncing_index", type="DEFAULT", rows=2, maxrows=4, sort_lock=True)
